		...
		<td class="left"></td>
			...
			<table>
				<tr>
					...
					<td style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold">Movimientos de Mermas  <?php echo "$sucu"; ?>
					</td>
					</tr>
					<tr>
...
@touch($logAcceso);
   ...
   $lineaTXT  = "Generó Movimientos Mermas: ".date("d/m/Y·H:i:s").".";  
