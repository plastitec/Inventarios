...
if($sucu=='LUC'){
   ...
   $sql ="SELECT MINVE04.CVE_ART, MINVE04.CVE_CPTO, MINVE04.FECHA_DOCU, MINVE04.REFER, MINVE04.CANT, MINVE04.ALMACEN, MINVE04.COSTO FROM MINVE04 WHERE MINVE04.FECHA_DOCU>='$fDesde' and MINVE04.FECHA_DOCU<='$fHasta' and MINVE04.CVE_CPTO = $movi order by MINVE04.FECHAELAB ASC";
...
echo"<td >$maskCantidad</td>";
echo"<td align ='right'>$almacen</td>";
echo"<td align ='right'>0.00000</td>";
...
@touch($logAcceso);
   ...
   $lineaTXT  = "Generó Movimientos Ventas: ".date("d/m/Y·H:i:s").".";  
