...
if($tmov == 'VENTAS') {  
   $counter=0;
   $nomTXT=null; 
   $sql ="SELECT MINVE03.CVE_ART, MINVE03.CVE_CPTO, MINVE03.FECHA_DOCU, MINVE03.REFER, SUM(MINVE03.CANT) AS CANT, MINVE03.ALMACEN, MINVE03.COSTO FROM MINVE03 WHERE MINVE03.FECHA_DOCU>='$fDesde' and MINVE03.FECHA_DOCU<='$fHasta' AND MINVE03.CVE_CPTO = 51 GROUP BY MINVE03.CVE_ART, MINVE03.REFER, MINVE03.CVE_CPTO, MINVE03.FECHA_DOCU, MINVE03.ALMACEN, MINVE03.COSTO order by MINVE03.FECHA_DOCU ASC";
...
if($tmov == 'DEVOLUCION') {   
   ...
   $nomTXT=null; 
   $sql ="SELECT MINVE03.CVE_ART, MINVE03.CVE_CPTO, MINVE03.REFER, SUM(MINVE03.CANT) AS CANT, MINVE03.ALMACEN, MINVE03.COSTO FROM MINVE03 WHERE MINVE03.FECHA_DOCU>='$fDesde' and MINVE03.FECHA_DOCU<='$fHasta' AND MINVE03.CVE_CPTO = 2 GROUP BY MINVE03.CVE_ART, MINVE03.REFER, MINVE03.CVE_CPTO, MINVE03.ALMACEN, MINVE03.COSTO ORDER BY MINVE03.REFER ASC";
   $sqlcanc ="SELECT MINVE03.CVE_ART, MINVE03.CVE_CPTO, MINVE03.REFER, SUM(MINVE03.CANT) AS CANT, MINVE03.ALMACEN, MINVE03.COSTO FROM MINVE03 WHERE MINVE03.FECHA_DOCU>='$fDesde' and MINVE03.FECHA_DOCU<='$fHasta' AND MINVE03.CVE_CPTO = 56 GROUP BY MINVE03.CVE_ART, MINVE03.REFER, MINVE03.CVE_CPTO, MINVE03.ALMACEN, MINVE03.COSTO";
   $sqlF="SELECT MINVE03.CVE_ART, MINVE03.FECHA_DOCU,MINVE03.REFER FROM MINVE03 WHERE MINVE03.CVE_CPTO = 2 AND ((MINVE03.FECHA_DOCU)>='$fDesde') and ((MINVE03.FECHA_DOCU)<='$fHasta') GROUP BY MINVE03.CVE_ART, MINVE03.FECHA_DOCU,MINVE03.REFER ORDER BY MINVE03.REFER, MINVE03.CVE_ART, MINVE03.FECHA_DOCU ASC  ";
   $sqlDoctoE="SELECT MINVE03.CVE_ART,MINVE03.REFER, DOCTOSIGF03.CVE_DOC_E FROM MINVE03 LEFT JOIN DOCTOSIGF03 ON MINVE03.REFER=DOCTOSIGF03.CVE_DOC WHERE MINVE03.CVE_CPTO = 2 AND ((MINVE03.FECHA_DOCU)>='$fDesde') and ((MINVE03.FECHA_DOCU)<='$fHasta') GROUP BY MINVE03.CVE_ART,MINVE03.REFER, DOCTOSIGF03.CVE_DOC_E ORDER BY MINVE03.REFER, MINVE03.CVE_ART ASC  ";
...
if($tmov == 'MERMAS') {  
   $counter=0;
   $nomTXT=null; 
   $sql ="SELECT MINVE03.CVE_ART, MINVE03.CVE_CPTO, MINVE03.FECHA_DOCU, MINVE03.REFER, SUM(MINVE03.CANT) AS CANT, MINVE03.ALMACEN, MINVE03.COSTO, MINVE03.FECHAELAB FROM MINVE03 WHERE MINVE03.FECHA_DOCU>='$fDesde' and MINVE03.FECHA_DOCU<='$fHasta' AND MINVE03.CVE_CPTO = 55 GROUP BY MINVE03.CVE_ART, MINVE03.REFER, MINVE03.CVE_CPTO, MINVE03.FECHA_DOCU, MINVE03.ALMACEN, MINVE03.COSTO, MINVE03.FECHAELAB order by MINVE03.FECHAELAB ASC";
